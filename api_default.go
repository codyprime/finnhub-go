...
func (r ApiAirlinePriceIndexRequest) Airline(airline string) ApiAirlinePriceIndexRequest {
	r.airline = &airline
	return r
}
...
func (r ApiAirlinePriceIndexRequest) Execute() (AirlinePriceIndexData, *_nethttp.Response, error) {
	return r.ApiService.AirlinePriceIndexExecute(r)
}

/*
AirlinePriceIndex Airline Price Index
...
func (a *DefaultApiService) AirlinePriceIndexExecute(r ApiAirlinePriceIndexRequest) (AirlinePriceIndexData, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  AirlinePriceIndexData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AirlinePriceIndex")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/airline/price-index"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.airline == nil {
		return localVarReturnValue, nil, reportError("airline is required and must be specified")
	}
	if r.from == nil {
	...
	localVarQueryParams.Add("airline", parameterToString(*r.airline, ""))
...
// Symbol.
func (r ApiBankBranchRequest) Symbol(symbol interface{}) ApiBankBranchRequest {
	r.symbol = &symbol
	return r
}

func (r ApiBankBranchRequest) Execute() (BankBranchRes, *_nethttp.Response, error) {
	return r.ApiService.BankBranchExecute(r)
}

/*
BankBranch Bank Branch List
...
func (a *DefaultApiService) BankBranchExecute(r ApiBankBranchRequest) (BankBranchRes, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  BankBranchRes
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.BankBranch")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/bank-branch"
...
func (r ApiBondYieldCurveRequest) Code(code string) ApiBondYieldCurveRequest {
	r.code = &code
	return r
}

func (r ApiBondYieldCurveRequest) Execute() (BondYieldCurve, *_nethttp.Response, error) {
	return r.ApiService.BondYieldCurveExecute(r)
}
...
func (a *DefaultApiService) BondYieldCurveExecute(r ApiBondYieldCurveRequest) (BondYieldCurve, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  BondYieldCurve
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.BondYieldCurve")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/bond/yield-curve"
...
// Symbol.
func (r ApiCompanyHistoricalEsgScoreRequest) Symbol(symbol string) ApiCompanyHistoricalEsgScoreRequest {
	r.symbol = &symbol
	return r
}

func (r ApiCompanyHistoricalEsgScoreRequest) Execute() (HistoricalCompanyESG, *_nethttp.Response, error) {
	return r.ApiService.CompanyHistoricalEsgScoreExecute(r)
}

/*
CompanyHistoricalEsgScore Historical ESG Scores
...
func (a *DefaultApiService) CompanyHistoricalEsgScoreExecute(r ApiCompanyHistoricalEsgScoreRequest) (HistoricalCompanyESG, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  HistoricalCompanyESG
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CompanyHistoricalEsgScore")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/historical-esg"
...
// Symbol of the company: AAPL.
func (r ApiCongressionalTradingRequest) Symbol(symbol string) ApiCongressionalTradingRequest {
	r.symbol = &symbol
	return r
}
// From date &lt;code&gt;YYYY-MM-DD&lt;/code&gt;.
...
func (r ApiCongressionalTradingRequest) Execute() (CongressionalTrading, *_nethttp.Response, error) {
	return r.ApiService.CongressionalTradingExecute(r)
}
...
func (a *DefaultApiService) CongressionalTradingExecute(r ApiCongressionalTradingRequest) (CongressionalTrading, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  CongressionalTrading
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CongressionalTrading")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/congressional-trading"
...
// From date &lt;code&gt;YYYY-MM-DD&lt;/code&gt;.
func (r ApiEarningsCallLiveRequest) From(from string) ApiEarningsCallLiveRequest {
	r.from = &from
	return r
}
// To date &lt;code&gt;YYYY-MM-DD&lt;/code&gt;.
...
func (r ApiEarningsCallLiveRequest) Execute() (EarningsCallLive, *_nethttp.Response, error) {
	return r.ApiService.EarningsCallLiveExecute(r)
}

/*
EarningsCallLive Earnings Call Audio Live
...
func (a *DefaultApiService) EarningsCallLiveExecute(r ApiEarningsCallLiveRequest) (EarningsCallLive, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  EarningsCallLive
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.EarningsCallLive")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/earnings-call-live"
...
func (a *DefaultApiService) FinancialsExecute(r ApiFinancialsRequest) (FinancialStatements, *_nethttp.Response, error) {
	...
	localVarQueryParams.Add("freq", parameterToString(*r.freq, ""))
	if r.preliminary != nil {
		localVarQueryParams.Add("preliminary", parameterToString(*r.preliminary, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
// Company symbol.
func (r ApiHistoricalEmployeeCountRequest) Symbol(symbol string) ApiHistoricalEmployeeCountRequest {
	r.symbol = &symbol
	return r
}
// From date &lt;code&gt;YYYY-MM-DD&lt;/code&gt;.
...
func (r ApiHistoricalEmployeeCountRequest) Execute() (HistoricalEmployeeCount, *_nethttp.Response, error) {
	return r.ApiService.HistoricalEmployeeCountExecute(r)
}

/*
HistoricalEmployeeCount Historical Employee Count
...
func (a *DefaultApiService) HistoricalEmployeeCountExecute(r ApiHistoricalEmployeeCountRequest) (HistoricalEmployeeCount, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  HistoricalEmployeeCount
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.HistoricalEmployeeCount")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/historical-employee-count"
...
// Company symbol.
func (r ApiHistoricalMarketCapRequest) Symbol(symbol string) ApiHistoricalMarketCapRequest {
	r.symbol = &symbol
	return r
}
// From date &lt;code&gt;YYYY-MM-DD&lt;/code&gt;.
...
func (r ApiHistoricalMarketCapRequest) Execute() (HistoricalMarketCapData, *_nethttp.Response, error) {
	return r.ApiService.HistoricalMarketCapExecute(r)
}
...
func (a *DefaultApiService) HistoricalMarketCapExecute(r ApiHistoricalMarketCapRequest) (HistoricalMarketCapData, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  HistoricalMarketCapData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.HistoricalMarketCap")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/historical-market-cap"
...
// Exchange code.
func (r ApiMarketHolidayRequest) Exchange(exchange string) ApiMarketHolidayRequest {
	r.exchange = &exchange
	return r
}

func (r ApiMarketHolidayRequest) Execute() (MarketHoliday, *_nethttp.Response, error) {
	return r.ApiService.MarketHolidayExecute(r)
}
...
func (a *DefaultApiService) MarketHolidayExecute(r ApiMarketHolidayRequest) (MarketHoliday, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MarketHoliday
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.MarketHoliday")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/market-holiday"
...
// Exchange code.
func (r ApiMarketStatusRequest) Exchange(exchange string) ApiMarketStatusRequest {
	r.exchange = &exchange
	return r
}

func (r ApiMarketStatusRequest) Execute() (MarketStatus, *_nethttp.Response, error) {
...
func (a *DefaultApiService) MarketStatusExecute(r ApiMarketStatusRequest) (MarketStatus, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MarketStatus
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.MarketStatus")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/market-status"
...
// ISIN.
func (r ApiMutualFundEetRequest) Isin(isin string) ApiMutualFundEetRequest {
	r.isin = &isin
	return r
}

func (r ApiMutualFundEetRequest) Execute() (MutualFundEet, *_nethttp.Response, error) {
	return r.ApiService.MutualFundEetExecute(r)
}
...
func (a *DefaultApiService) MutualFundEetExecute(r ApiMutualFundEetRequest) (MutualFundEet, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MutualFundEet
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.MutualFundEet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mutual-fund/eet"
...
// ISIN.
func (r ApiMutualFundEetPaiRequest) Isin(isin string) ApiMutualFundEetPaiRequest {
	r.isin = &isin
	return r
}

func (r ApiMutualFundEetPaiRequest) Execute() (MutualFundEetPai, *_nethttp.Response, error) {
	return r.ApiService.MutualFundEetPaiExecute(r)
}
...
func (a *DefaultApiService) MutualFundEetPaiExecute(r ApiMutualFundEetPaiRequest) (MutualFundEetPai, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MutualFundEetPai
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.MutualFundEetPai")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mutual-fund/eet-pai"
...
// Symbol.
func (r ApiRevenueBreakdown2Request) Symbol(symbol string) ApiRevenueBreakdown2Request {
	r.symbol = &symbol
	return r
}

func (r ApiRevenueBreakdown2Request) Execute() (RevenueBreakdown2, *_nethttp.Response, error) {
	return r.ApiService.RevenueBreakdown2Execute(r)
}

/*
RevenueBreakdown2 Revenue Breakdown & KPI
...
func (a *DefaultApiService) RevenueBreakdown2Execute(r ApiRevenueBreakdown2Request) (RevenueBreakdown2, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  RevenueBreakdown2
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.RevenueBreakdown2")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/revenue-breakdown2"
...
// Company symbol.
func (r ApiStockPresentationRequest) Symbol(symbol string) ApiStockPresentationRequest {
	r.symbol = &symbol
	return r
}

func (r ApiStockPresentationRequest) Execute() (StockPresentation, *_nethttp.Response, error) {
	return r.ApiService.StockPresentationExecute(r)
}

/*
StockPresentation Company Presentation
...
func (a *DefaultApiService) StockPresentationExecute(r ApiStockPresentationRequest) (StockPresentation, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  StockPresentation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.StockPresentation")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/stock/presentation"
